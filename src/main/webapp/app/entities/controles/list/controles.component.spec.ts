...
import { sampleWithRequiredData } from '../controles.test-samples';
import { ControlesService } from '../service/controles.service';

import { ControlesComponent } from './controles.component';
import SpyInstance = jest.SpyInstance;

describe('Controles Management Component', () => {
  let comp: ControlesComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ControlesComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to controlesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getControlesIdentifier');
      const id = comp.trackId(entity);
      expect(service.getControlesIdentifier).toHaveBeenCalledWith(entity);
