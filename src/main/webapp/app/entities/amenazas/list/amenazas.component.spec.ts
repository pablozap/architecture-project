...
import { sampleWithRequiredData } from '../amenazas.test-samples';
import { AmenazasService } from '../service/amenazas.service';

import { AmenazasComponent } from './amenazas.component';
import SpyInstance = jest.SpyInstance;

describe('Amenazas Management Component', () => {
  let comp: AmenazasComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(AmenazasComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.amenazas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to amenazasService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAmenazasIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAmenazasIdentifier).toHaveBeenCalledWith(entity);
