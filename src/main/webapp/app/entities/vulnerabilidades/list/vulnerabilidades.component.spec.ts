...
import { sampleWithRequiredData } from '../vulnerabilidades.test-samples';
...
describe('Vulnerabilidades Management Component', () => {
  let comp: VulnerabilidadesComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(VulnerabilidadesComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.vulnerabilidades?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to vulnerabilidadesService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getVulnerabilidadesIdentifier');
      const id = comp.trackId(entity);
      expect(service.getVulnerabilidadesIdentifier).toHaveBeenCalledWith(entity);
